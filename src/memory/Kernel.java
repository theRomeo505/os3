...
public class Kernel extends Thread
{
  ...
  //////////
  public ArrayList<Page> lru=new ArrayList();
  //////////
  ...
  public void step()
  {
    ...
    if ( instruct.inst.startsWith( "READ" ) )
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage(lru, memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel );
    ...
    if ( instruct.inst.startsWith( "WRITE" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage( lru,memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel );          controlPanel.pageFaultValueLabel.setText( "YES" );
      } 
      else 
      {
        page.M = 1;
